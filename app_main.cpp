...
void Display()
{
	...
	glColor3f(1, 0, 0);
	if (turn == 1)
		DrawString(GLUT_BITMAP_8_BY_13, "It is Player 1's Turn, Your Mark is X", 1, 30);
	else
		DrawString(GLUT_BITMAP_8_BY_13, "It is Player 2's Turn, Your Mark is o", 1, 30);
	...
	if (over == true)
	{
		DrawString(GLUT_BITMAP_8_BY_13, "Game Is Over!", 100, 160);
		if (result == 0)
			DrawString(GLUT_BITMAP_8_BY_13, "The Result is a Draw!", 110, 185);
		if (result == 1)
			DrawString(GLUT_BITMAP_8_BY_13, "Player1 has won!", 95, 185);
		if (result == 2)
			DrawString(GLUT_BITMAP_8_BY_13, "Player2 has won!", 95, 185);
		DrawString(GLUT_BITMAP_8_BY_13, "Do you want to continue (y/n)", 40, 210);
	}
	glutSwapBuffers();
}
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Tic Tac Toe: By David Talabi");
